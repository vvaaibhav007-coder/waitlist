          ...
          >
            ...
            <div className="mb-8 relative z-20">
              ...
              <div className="flex justify-center relative z-20 mt-6">
                <a
                  href="https://checkout.dodopayments.com/buy/pdt_0NcKuKeKzGrwnr2py8gGW?quantity=1"
                  className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl bg-[#6E9EEB] hover:bg-[#5a8bd6] text-white font-semibold text-lg transition-all shadow-[0_0_20px_rgba(110,158,235,0.4)] hover:shadow-[0_0_30px_rgba(110,158,235,0.6)]"
                >
